...
**Releases:** `scripts/release.ps1 -Version x.y.z` does the whole cut — version bump across
...
(`src-tauri/binaries/fieldcatalog.exe`, PyInstaller onefile) and bundles it beside the app exe.
